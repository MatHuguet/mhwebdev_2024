...
<header>
    ...
    <div class="social">
        <div class="icons">
            <div class="linkedin"><a class="icon-img" href="" target="_blank"><img src="/public/images/icons/la--linkedin-in.svg" alt="logo linkedin" /></a>
            </div>
            <div class="github"><a class="icon-img" href="" target="_blank"><img src="/public/images/icons/ant-design--github-filled.svg" alt="logo github" /></a>
            </div>
            <div class="mail"><a class="icon-img" href="" target="_blank"><img src="/public/images/icons/tabler--mail-filled.svg" alt="logo email" /></a>
            </div>
        </div>
    </div>
</header>