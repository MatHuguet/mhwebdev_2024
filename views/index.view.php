...
<section class="description">
    ...
    Pendant plus de 10 ans j'ai travaillé dans l'hôtellerie et l'événementiel,
        en commençant en tant qu'employé polyvalent de jour et de nuit dans un hôtel proche d'Angers avant d'en prendre la gérance.
    Je suis ensuite devenu régisseur général d'un château dans un domaine de 9 hectares accueillant des événements tels que des mariages, des fêtes
        de famille ainsi que des séminaires.<br><br>
        Souhaitant me tourner vers un univers qui m'attire depuis l'enfance, je décide en 2022 de me reconvertir professionnellement dans le
        développement informatique, et plus précisément dans le développement web.<br>
        Le code me permet de développer mon sens de la <strong>rigueur</strong>, et celui de <strong>l'organisation</strong>. <strong>Curieux</strong> par nature, je prends plaisir à découvrir les langages
        et leurs fonctionnalités. Cette apétance est enrichie par ma <strong>polyvalence</strong> qui me permet d'absorber rapidement de multiples informations et de
        m'adapter à mon environnement de travail.<br><br>
        Ma <strong>créativité</strong> se retrouve également mobilisée pour résoudre les multiples problèmes qui peuvent se poser
